                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating date" id="date3" data-target-input="nearest">
                                <input type="text" name="date" class="form-control datetimepicker-input" id="datetime"
                        ...
                        <div class="col-12">
                            <input type="submit" class="btn btn-primary w-100 py-3" name="submit" value="Book Now">
                        </div>
                    </div>
                </form>
            </div>
