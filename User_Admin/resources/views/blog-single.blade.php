        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-single-item">
                    <img src="{{URL('files/images/01-big-blog.jpg')}}" alt="">
                ...
                <div class="blog-comments">
                    ...
                    <ul class="coments-content">
                        <li class="first-comment-item">
                            <img src="{{URL('files/images/01-author-comment.jpg')}}" alt="">
                        ...
                        <li class="second-comment-item">
                            <img src="{{URL('files/images/02-author-comment.jpg')}}" alt="">
                        ...
                        <li class="third-comment-item">
                            <img src="{{URL('files/images/03-author-comment.jpg')}}" alt="">
                ...
                <div class="widget-item">
                    ...
                    <ul class="recent-item">
                        <li class="recent-post-item">
                            <a href="#">
                                <img src="{{URL('files/images/01-recentpost.jpg')}}" alt="">
                        ...
                        <li class="recent-post-item">
                            <a href="#">
                                <img src="{{URL('files/images/02-recentpost.jpg')}}" alt="">
                        ...
                        <li class="recent-post-item">
                            <a href="#">
                                <img src="{{URL('files/images/03-recentpost.jpg')}}" alt="">
