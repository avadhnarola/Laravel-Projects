...
<body>
    <div class="m-auto">
        <div class="container mt-5">
            <form class="form_container m-auto" method="POST">
                @csrf
                <div class="title_container">
                    <p class="title" style="font-size: 1.5rem; font-family:cursive;">Login to your Account</p>
                </div>
                <br>
                <div class="input_container">
                    ...
                    <input placeholder="name@mail.com" name="email" type="text" class="input_field" required
                        id="email_field">
                </div>
                <div class="input_container">
                ...
                <input title="Sign In" type="submit" class="sign-in_btn" name="submit" value="Sign In">
                
                <p class="sign-up-label">
                    Don't have an account?<a href="{{URL('/register')}}" class="sign-up-link">Sign up</a>
                </p>
            </form>
        </div>
    </div>
