        ...
        <div class="fullwidthbanner">
            <ul>
                <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                    <img src="{{URL('files/images/01-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
                    <div class="tp-caption first-line lft tp-resizeme start" data-x="center" data-hoffset="0"
                        ...
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">YOM-DOWNLOAD ANYTHING</div>
                    <div class="tp-caption second-line lfb tp-resizeme start" data-x="center" data-hoffset="0"
                        ...
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">From Yom you can download
                ...
                <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                    <img src="{{URL('files/images/02-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
                    <div class="tp-caption first-line lft tp-resizeme start" data-x="center" data-hoffset="0"
                        data-y="250" data-speed="1000" data-start="200" data-easing="Power4.easeOut" data-splitin="none"
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">Create a Multi Author Blog
                    </div>
                    <div class="tp-caption second-line lfb tp-resizeme start" data-x="center" data-hoffset="0"
                        data-y="340" data-speed="1000" data-start="800" data-easing="Power4.easeOut" data-splitin="none"
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">Using Yom you can create
                        multi author Blog platform</div>
                    <div class="tp-caption slider-btn sfb tp-resizeme start" data-x="center" data-hoffset="0"
                        data-y="510" data-speed="1000" data-start="2200" data-easing="Power4.easeOut"
                        data-splitin="none" data-splitout="none" data-elementdelay="0" data-endelementdelay="0"><a
                            href="#" class=" second-btn btn btn-slider">Discover More</a></div>
                </li>
                <li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
                    <img src="{{URL('files/images/03-slide.jpg')}}" data-fullwidthcentering="on" alt="slide">
                    <div class="tp-caption first-line lft tp-resizeme start" data-x="center" data-hoffset="0"
                        data-y="250" data-speed="1000" data-start="200" data-easing="Power4.easeOut" data-splitin="none"
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">Create an E-commerce Site
                    </div>
                    <div class="tp-caption second-line lfb tp-resizeme start" data-x="center" data-hoffset="0"
                        data-y="340" data-speed="1000" data-start="800" data-easing="Power4.easeOut" data-splitin="none"
                        data-splitout="none" data-elementdelay="0" data-endelementdelay="0">Using Yom your can create a
...
<section class="services green">
    <div class="container">
        ...
        <div class="service-item col-md-4">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum nam numquam voluptates cumque
                inventore, quibusdam corporis consequatur amet.</p>
        </div>
        <div class="service-item col-md-4">
    ...
    <div class="container">
        <div class="left-text hidden-xs">
            ...
            <p><em>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi ut explicabo magni
                    sapiente.</em><br><br>Inventore at quia, vel in repellendus, cumque dolorem autem ad quidem mollitia
                porro blanditiis atque rerum debitis eveniet nostrum aliquam. Sint aperiam expedita sapiente amet
                officia quis perspiciatis adipisci, iure dolorem esse exercitationem!</p>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div id="owl-portfolio" class="owl-carousel owl-theme">
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/01-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/02-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/03-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/04-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/05-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/06-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/07-portfolio.jpg')}}">
                            <figcaption>
                    ...
                    <div class="item">
                        <figure>
                            <img alt="portfolio" src="{{URL('files/images/08-portfolio.jpg')}}">
                            <figcaption>
                ...
                <div id="owl-demo" class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="testimonials-post">
                            ...
                            <p>“ At vero eos et accusamus et iusto odio dignissimos ducimus qui molestias excepturi
                                blanditis ”</p>
...
<section class="blog-posts">
    <div class="container">
        ...
        <div class="blog-item">
            <div class="col-md-4">
                <a href="blog-single.html"><img src="{{URL('files/images/01-blog.jpg')}}" alt=""></a>
                <h3><a href="blog-single.html">Lorum Ipsum5</a></h3>
                <span><a href="#">Syam Kesav</a> / <a href="#">6 June 2015</a> / <a href="#">Uncategorized</a></span>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit alis quam est leo, imperdiet eget dictum sed,
                    congue non erosa senean sed ligula hendrerit...</p>
                <div class="read-more">
        ...
        <div class="blog-item">
            <div class="col-md-4">
                <a href="blog-single.html"><img src="{{URL('files/images/02-blog.jpg')}}" alt=""></a>
                <h3><a href="blog-single.html">Lorum Ipsum5</a></h3>
        ...
        <div class="blog-item">
            <div class="col-md-4">
                <a href="blog-single.html"><img src="{{URL('files/images/03-blog.jpg')}}" alt=""></a>
                <h3><a href="blog-single.html">Lorum Ipsum5</a></h3>
