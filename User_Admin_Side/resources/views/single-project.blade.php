            ...
            <div class="col-md-8">
                <div class="single-project-item">
                            ...
                            <div class="fullwidthbanner">
                                <ul>
                                    <li class="first-slide" data-transition="fade" data-slotamount="10"
                                        ...
                                        <img src="files/images/01-big-portfolio.jpg" data-fullwidthcentering="on"
                                            alt="slide">
                                    </li>
                                    <li class="first-slide" data-transition="fade" data-slotamount="10"
                                        data-masterspeed="300">
                                        <img src="files/images/02-big-portfolio.jpg" data-fullwidthcentering="on"
                                            alt="slide">
                                    </li>
                                    <li class="first-slide" data-transition="fade" data-slotamount="10"
                                        data-masterspeed="300">
                                        <img src="files/images/03-big-portfolio.jpg" data-fullwidthcentering="on"
                                            alt="slide">
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="single-content">
                        ...
                        <span><a href="#">Syam Imeri</a> / <a href="#">6 June 2015</a> / <a
                ...
                <div class="single-project-sidebar">
                    <div class="about-author">
                        ...
                        <div class="author-contet">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt quis ullam explicabo
                                facere numquam architecto.</p>
                        </div>
                    </div>
